...
function ${displayName}IndexPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <PageHeader
        title="${displayName}"
        description="${description ?? `Manage your ${pluralName}`}"
        action={
          <Button asChild>
...
function generateParquetRouteIndex(params: RouteIndexParams): string {
  ...
  const iconImports = analyticsEnabled ? 'Plus, Search, BarChart3' : 'Plus, Search'

  return `// 🔄 GENERATED by codegen - parquet/DuckDB data source
